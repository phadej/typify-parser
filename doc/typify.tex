...
\syntaxrule{Named}{n : \mathsf{type} \quad p : \mathsf{type}}{n : p : \mathsf{type}}
\\&
\textbf{Brackets:} \\&
\syntaxrule{Square}{p : \mathsf{type}}{[p] : \mathsf{type}} \qquad
\syntaxrule{Curly}{p : \mathsf{type}}{\{p\} : \mathsf{type}}
\\&
\textbf{Functions:} \\&
